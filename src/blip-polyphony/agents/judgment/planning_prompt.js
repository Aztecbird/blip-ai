...
6. CRITICAL: If no tool is appropriate for the request (e.g., controlling YouTube, playing music, opening unlisted apps, photo editing, saving videos), DO NOT guess or hallucinate tools. Output an empty plan array [] and let the fallback system handle it.
